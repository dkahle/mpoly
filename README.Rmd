...
Using [tidyversestyle coding](https://www.tidyverse.org) (install tidyverse packages with `install.packages("tidyverse")`), this looks a bit cleaner:
```{r as-funtion-multi-tidy}
...
__Grobner bases are no longer implemented in mpoly; they're now in [m2r](https://github.com/musicman3320/m2r).__
